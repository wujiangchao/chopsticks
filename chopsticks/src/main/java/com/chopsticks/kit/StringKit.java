...
import com.chopsticks.mvc.multipart.MimeType;
...
public class StringKit {
	...
	/**
	 * Fill a certain number of special characters on the left side of the
	 * string
	 *
	 * @param o
	 *            objects that can be to String
	 * @param width
	...
	/**
	 * Fill a certain number of special characters on the right side of the
	 * string
	 *
	 * @param o
	 *            objects that can be to String
