...
public class ChopsticksTemplate {
    ...
    private ChopsticksTemplate(String str) {
        this.str = str;
    }

    public static ChopsticksTemplate template(String str) {
        return new ChopsticksTemplate(str);
    }

    public static ChopsticksTemplate template(String str, Object... args) {
        return template(str).args(args);
    }

    public static ChopsticksTemplate template(String str, Map<String, Object> args) {
        return template(str).args(args);
    }

    public static ChopsticksTemplate fromFile(String strPath) {
        return template(readFromFile(strPath));
    }

    public static ChopsticksTemplate fromFile(String strPath, Charset encoding) {
        return template(readFromFile(strPath, encoding));
    }

    public static ChopsticksTemplate fromFile(String strPath, Object... args) {
        return template(readFromFile(strPath), args);
    }

    public static ChopsticksTemplate fromFile(String strPath, Charset encoding, Object... args) {
        return template(readFromFile(strPath, encoding), args);
    }

    public static ChopsticksTemplate fromFile(String strPath, Map<String, Object> args) {
        return template(readFromFile(strPath), args);
    }

    public static ChopsticksTemplate fromFile(String strPath, Charset encoding, Map<String, Object> args) {
        return template(readFromFile(strPath, encoding), args);
    }
    ...
    public ChopsticksTemplate arg(String argName, Object object) {
        failIfArgExists(argName);
        this.arguments.put(argName, object);
        return this;
    }

    public ChopsticksTemplate args(Map<String, Object> args) {
    ...
    public ChopsticksTemplate args(Object... args) {
        if (args.length % 2 == 1)
